# EVGo Mobile App - Design System

> **Project**: EVGo Mobile Application  
...
This Design System was extracted from the Frontend source code of the **EVGo Mobile App** project - a React Native application built with the Expo framework, using **NativeWind** (Tailwind CSS for React Native) for styling.
...
| **Caption**       | `text-xs`       | -                      | -           | _(Not seen in use)_           |
...
**Features:** _(Need to view file for detailed analysis)_
...
- _(Need to view store files for detailed analysis)_
...
export default function ComponentName({ props }: ComponentProps) {
  ...
  // 6. JSX Return
  return <View className="...">{/* Component markup */}</View>;
}
```
...
// Input wrapper
className =
  "flex-row items-center bg-primary/90 mb-6 px-2 py-[2px] rounded-full";
...
The **EVGo Mobile App** Design System has a good foundation with:
