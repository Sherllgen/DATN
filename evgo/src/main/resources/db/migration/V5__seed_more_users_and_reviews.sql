...
VALUES (
        ...
        NOW(),
        NOW(),
        'https://tse4.mm.bing.net/th/id/OIP.ObkhpVkyROzokw2FqVdgJwHaHs?rs=1&pid=ImgDetMain&o=7&rm=3'
    ),
    (
        12,
        'user2@example.com',
        ...
        NOW(),
        NOW(),
        'https://tse2.mm.bing.net/th/id/OIP.Lnnry0dKhaHkvbsnug_-LgHaEK?rs=1&pid=ImgDetMain&o=7&rm=3'
    ),
    (
        13,
        'user3@example.com',
        ...
        NOW(),
        NOW(),
        'https://images.wallpapersden.com/image/download/pc-marvel-s-spider-man-remastered_bWpqameUmZqaraWkpJRmbmdlrWZlbWU.jpg'
    ),
    (
        14,
        'user4@example.com',
        ...
        NOW(),
        NOW(),
        'https://i.pinimg.com/originals/76/34/55/7634550e3a215d2da8dc659b174b2689.jpg'
    ),
    (
        15,
        'user5@example.com',
        ...
        NOW(),
        NOW(),
        'https://th.bing.com/th/id/R.5191c9714a8f9b0adbeb94029fe6a7dc?rik=1IbprZNfGN44lw&pid=ImgRaw&r=0'
...
INSERT INTO "reviews" (station_id, user_id, rating, comment, created_at)
VALUES -- Station 1: EVGo Bitexco Central
    (
        1,
        11,
        5,
        'Great charging station, right in the center.',
        NOW()
    ),
    (
        1,
        12,
        4,
        'A bit crowded during peak hours but charges fast.',
        NOW()
    ),
    ...
    (
        ...
        4,
        4,
        'Beautiful view, stable charging.',
        NOW()
    ),
    (
        2,
        11,
        5,
        'Very convenient when visiting the palace.',
        NOW()
    ),
    (
        2,
        12,
        3,
        'Price is a bit higher than other places.',
        NOW()
    ),
    -- Station 4: KTX Khu B
    ...
    (
        ...
        14,
        2,
        'Frequent connection issues with the app.',
        NOW()
    ),
    -- Station 5: Suoi Tien
    ...
    (
        ...
        4,
        4,
        'Very convenient to charge while shopping at the supermarket.',
        NOW()
    ),
    ...
    (
        ...
        14,
        5,
        'Parking staff are very helpful.',
        NOW()
    ),
    ...
    (
        ...
        15,
        2,
        'This area is prone to traffic jams.',
        NOW()
    ),
    ...
    (
        ...
        15,
        3,
        'A bit old but still works well.',
        NOW()
    ),
    ...
    (
        ...
        4,
        5,
        'Many charging stations, no long wait.',
        NOW()
    ),
    ...
    (
        ...
        13,
        5,
        'New urban area, very smooth charging.',
        NOW()
    ),
    (
        20,
